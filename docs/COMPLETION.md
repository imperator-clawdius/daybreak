...
| Live site surface remains clean | `npm run verify:launch` reports `surface_clean=true` for the primary live site and `scripts/verify-launch.test.ts` proves launch stays pending when buyer-visible pages contain common tracker markers, insecure public URLs, or unexpected external HTTPS hosts |
