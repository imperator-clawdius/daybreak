...
| Unsigned installer packages | `npm run package -w @daybreak/desktop` -> `desktop/release/Daybreak Setup 0.1.0.exe`; current unsigned SHA-256 is `94eef062dda14aa32972e07dbb7b9b000258b345f3dfc4c0ba58b009e59c9de8`; signing skipped because no cert is configured |
