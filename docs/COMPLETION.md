...
| Unsigned installer packages | `npm run package -w @daybreak/desktop` -> `desktop/release/Daybreak Setup 0.1.0.exe`; current unsigned SHA-256 is `bf232e9f3d8e8721f7a77e6872e8631f132d0df313a290d97cdfce6ee86a90f2`; signing skipped because no cert is configured |
