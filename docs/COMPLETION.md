...
| Legal pages publish an effective date | Privacy and terms share `LEGAL_EFFECTIVE_DATE = "June 23, 2026"` and `scripts/site-export-metadata.test.ts` proves both exported legal pages render `Effective June 23, 2026` |
