...
| Item | Evidence |
| --- | --- |
| Core mechanic works and is tested | `vitest run` -> **61 tests, 9 files passed** (wipe machine, carry-over, morning commit gate, same-day migration, IPC log-update validation, streak, commit validation, external-link policy, readiness URL proof, launch verifier, release preflight) |
