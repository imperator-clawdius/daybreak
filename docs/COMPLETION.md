...
| Unsigned installer packages | `npm run package -w @daybreak/desktop` -> `desktop/release/Daybreak Setup 0.1.0.exe`; current unsigned SHA-256 is `dfd8b5d2892e578700a5344d3ab78615c71ace3602dbbe8f406a07a74afbf3df`; signing skipped because no cert is configured |
