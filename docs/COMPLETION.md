...
| Unsigned installer packages | `npm run package -w @daybreak/desktop` -> `desktop/release/Daybreak Setup 0.1.0.exe`; current unsigned SHA-256 is `acbdd9b9d9aa7859ad369b33fef9dc7db4237da0659a36f0b10fa3e1c1ef6f9f`; signing skipped because no cert is configured |
