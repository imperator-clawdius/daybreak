...
| Unsigned installer packages | `npm run package -w @daybreak/desktop` -> `desktop/release/Daybreak Setup 0.1.0.exe`; current unsigned SHA-256 is `1d36f1ab7975229abe7375bc66ebe8b698906e96c7294ee3f78d76c417392b89`; signing skipped because no cert is configured |
