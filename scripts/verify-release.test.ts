    ...
    withTempDir((dir) => {
      ...
      const result = evaluatePackagedSmoke({
        ...
        runnerResult: {
          ...
          signal: null,
          stdout:
            "DAYBREAK_SMOKE=pass renderer_loaded=true ipc_roundtrip=true scenario=morning app_menu_disabled=true devtools_disabled=true web_preferences=strict shortcuts_blocked=true single_instance_lock=true close_probe=true swipe_flow=true",
          stderr: "",
        },
      });
          ...
          },
          {
            ...
            result: evaluatePackagedSmoke({
              ...
              runnerResult: {
                ...
                signal: null,
                stdout:
                  "DAYBREAK_SMOKE=pass renderer_loaded=true ipc_roundtrip=true scenario=evening app_menu_disabled=true devtools_disabled=true web_preferences=strict shortcuts_blocked=true single_instance_lock=true close_probe=true swipe_flow=true streak_summary=true",
                stderr: "",
              },
            }),
          },
          ...
          },
          {
            ...
            result: evaluatePackagedSmoke({
              ...
              runnerResult: {
                ...
                signal: null,
                stdout:
                  "DAYBREAK_SMOKE=pass renderer_loaded=true ipc_roundtrip=true scenario=evening app_menu_disabled=true devtools_disabled=true web_preferences=strict shortcuts_blocked=true single_instance_lock=true close_probe=true swipe_flow=true",
                stderr: "",
              },
            }),
          },
