...
describe("completion ledger", () => {
  it("keeps the documented test-count evidence current", () => {
    ...
    expect(ledger).toContain("**332 tests, 35 files passed**");
    ...
    expect(ledger).toContain("IPC payload-shape validation");
    ...
    expect(ledger).toContain("persisted item identity validation");
    expect(ledger).toContain("persisted day uniqueness validation");
    ...
    expect(ledger).not.toContain("**331 tests, 35 files passed**");
    expect(ledger).not.toContain("**330 tests, 35 files passed**");
    expect(ledger).not.toContain("**329 tests, 35 files passed**");
